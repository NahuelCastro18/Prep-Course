...
describe.only('suma(x, y)', function() {
...
describe.only('resta(x, y)', function() {
...
describe.only('divide(x, y)', function() {
...
describe.only('multiplica(x, y)', function() {
...
describe.only('sonIguales(x, y)', function() {
...
describe.only('menosQueNoventa(num)', function() {
...
describe.only('obtenerResto(x, y)', function() {
...
describe.only('esPar(num)', function() {
...
describe.only('esImpar(num)', function() {
...
describe.only('elevarAlCuadrado(num)', function() {
...
describe.only('elevarAlCubo(num)', function() {
...
describe.only('elevar(num, exponent)', function() {
...
describe.only('redondearNumero(num)', function() {
...
describe.only('redondearHaciaArriba(num)', function() {
