...
describe.only('mayuscula(nombre)', function() {
...
describe.only('invocarCallback(cb)', function() {
...
describe.only('operacionMatematica(n1, n2, cb)', function() {
...
describe.only('sumarArray(cb)', function() {
...
describe.only('forEach(arr, cb)', function() {
...
describe.only('filter(array)', function() {
